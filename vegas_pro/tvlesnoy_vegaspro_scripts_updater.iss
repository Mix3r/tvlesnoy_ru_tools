...
Filename: "{tmp}\git\VegasPro-13.0.545.exe"; Components: videoeditor1/en; Parameters: "/E"; Flags: runascurrentuser;
Filename: "{tmp}\git\VegasPro-13.0.545.exe"; Components: videoeditor1/ru; Parameters: "/R"; Flags: runascurrentuser;
