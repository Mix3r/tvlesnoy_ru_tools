...
; Masks encoded
Filename: reg.exe; Parameters: "ADD ""HKEY_CURRENT_USER\Software\Sony Creative Software\VEGAS Pro\13.0\Metrics\Application"" /v S4600  /t /d NARRATOR_BG_RGB_0_86_172 /f"; Components: videoeditor1; Flags: runhidden runascurrentuser;
